...
![](./figure/三种拟合系数计算的相对大气质量.bmp)

​									图3 三种拟合系数计算的大气质量

![](./figure/几种方法计算的大气质量的误差值.bmp)
...
[1] Kasten,"A New Table and Approximation Formula for the Relative Optical AirMass",Arch.Meteorol.Geophys.Bioklimatol.Ser.B 14,206-223(1965).
